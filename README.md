...
This project is an end-to-end AI-driven investment platform that provides smart portfolio 
...
Built using LangGraph + LLM (Groq - LLaMA 3.1)
...
User Input → Market Analysis → Risk Analysis → Portfolio Optimization → Scenario Simulation → AI Explanation → Final Recommendation
